/**
 * Кнопка входа через Google (замена hasyx OAuthButtons).
 * Экспортируется как OAuthButtons для совместимости с портированным AppPage.
 */
import { signIn } from '#/lib/auth-client'

export function OAuthButtons(_props: Record<string, unknown>) {
  return (
    <button
      type="button"
