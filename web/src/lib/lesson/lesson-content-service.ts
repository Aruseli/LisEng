...
interface LessonQuestion {
  ...
  /** 'translation' — задание на перевод русского текста; влияет на UI (textarea) */
  kind?: 'translation';
}
...
Включи блок "readingPassages" с полным текстом. Также создай минимум 3-5 вопросов на понимание в exercise.questions.`;
  ...
  "exercise": {
    ...
    "questions": [
      ...
      {
        "prompt": "Переведи текст на английский, используя изученную структуру: [русский текст из 2-3 предложений]",
        "expectedAnswer": "Пример перевода на английском (это лишь один из допустимых вариантов)",
        "hint": "Используй структуру из урока и сигнальные слова",
        "evaluationCriteria": ["Сохранён смысл каждого предложения оригинала", "Правильное использование структуры", "Грамматическая корректность"],
        "kind": "translation"
      }
    ]
  }
