// @ts-nocheck — vendored-код, поведение зафиксировано тестами эквивалентности (generator.test.ts)
// Vendored from hasyx@0.2.0-alpha.70 (github.com/ivansglazunov/hasyx, lib/generator.ts)
// Патчи: убраны зависимости @apollo/client и ./debug; query возвращается строкой.
export type DocumentNode = string;
const gql = (s: string): DocumentNode => s;
const Debug = (_ns: string) => (..._args: unknown[]) => {};
